...
import v3.Balise;
import v3.Satellite;
import v3.BaliseView;
import v3.SatelliteView;
...
public class CommandClasses {
    ...
    class CreateSatelliteCommand implements Command {
        ...
        public void execute(SimulationContext context) {
            ...
            Satellite.MovementPattern pattern = parsePattern((String) params.getOrDefault("pattern", "#horizontal"));
    ...
    class CreateBeaconCommand implements Command {
        private final String variableName;
        private final Map<String, Object> params;
